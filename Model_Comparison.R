...
plot(m1) # DAG
draws1 <- greta::mcmc(m1, n_samples = 1000) # sampling
...
plot(m2) # DAG
draws2 <- greta::mcmc(m2, n_samples = 1000) # sampling
...
plot(m3) # DAG
draws3 <- greta::mcmc(m3, n_samples = 1000) # sampling

mcmc_trace(draws3)
summary(draws3)
mcmc_intervals(draws3)
...
mcmc_combo(as.array(stan4.samples), pars = c("N[1]","N[2]", "p[1]", "p[2]"))
...
# sampling
draws4 <- greta::mcmc(m4, n_samples = 1000)
plot(m4)

mcmc_trace(draws4)
summary(draws4)
mcmc_intervals(draws4)
